        ...
        <div className="w-[80%] md:max-w-[800px] mx-auto mt-5 leading-6 font-roboto mb-8">
            <div className="flex flex-col space-y-4">
                ...
                <p>
                    ...
                    general terms and conditions of your use of the nesterin.com
                    website (“Website”), “Nesterin Pickleball League” mobile
                    ...
                    “your”) and Nesterin LLC (“Nesterin LLC”, “we”, “us” or
                    “our”). If you are entering into this Agreement on behalf of
                    a business or other legal entity, you represent that you
                    have the authority to bind such entity to this Agreement, in
                    which case the terms “User”, “you” or “your” shall refer to
                    such entity. If you do not have such authority, or if you do
                    not agree with the terms of this Agreement, you must not
                    accept this Agreement and may not access and use the
                    Services. By accessing and using the Services, you
                    acknowledge that you have read, understood, and agree to be
                    bound by the terms of this Agreement. You acknowledge that
                    this Agreement is a contract between you and Nesterin LLC,
            ...
            <div className="flex flex-col space-y-4 mt-5">
                ...
                <p>
                    ...
                    effect at the time a fee or charge is due and payable. Where
                    Services are offered on a free trial basis, payment may be
                    required after the free trial period ends, and not when you
                    enter your billing details (which may be required prior to
                    the commencement of the free trial period). Sensitive and
                    private data exchange happens over a SSL secured
                    communication channel and is encrypted and protected with
                    digital signatures, and the Services are also in compliance
                    with PCI vulnerability standards in order to create as
                    secure of an environment as possible for Users. Scans for
                    malware are performed on a regular basis for additional
            ...
            <div className="flex flex-col space-y-4 mt-5">
                ...
                <p>
                    ...
                    the Services or Services is inaccurate at any time without
                    prior notice (including after you have submitted your
                    order). We undertake no obligation to update, amend or
                    clarify information on the Services including, without
                    limitation, pricing information, except as required by law.
                    No specified update or refresh date applied on the Services
            ...
            <div className="flex flex-col space-y-4 mt-5">
                ...
                <p>
                    ...
                    be advised that your access and use of such other services
                    are governed solely by the terms and conditions of such
                    other services, and we do not endorse, are not responsible
                    or liable for, and make no representations as to any aspect
                    of such other services, including, without limitation, their
                    content or the manner in which they handle data (including
                    your data) or any interaction between you and the provider
                    of such other services. You irrevocably waive any claim
                    against Nesterin LLC with respect to such other services.
                    Nesterin LLC is not liable for any damage or loss caused or
                    alleged to be caused by or in connection with your
                    enablement, access or use of any such other services, or
                    your reliance on the privacy practices, data security
                    processes or other policies of such other services. You may
                    be required to register for or log into such other services
                    on their respective platforms. By enabling any other
                    services, you are expressly permitting Nesterin LLC to
            ...
            <div className="flex flex-col space-y-4 mt-5">
                ...
                <p>
                    ...
                    such activity, is solely between you and the applicable
            ...
            <div className="flex flex-col space-y-4 mt-5">
                ...
                <p>
                    ...
                    links on the Services may be “affiliate links”. This means
                    if you click on the link and purchase an item, Nesterin LLC
                    will receive an affiliate commission. We are not responsible
                    for examining or evaluating, and we do not warrant the
                    offerings of, any businesses or individuals or the content
                    of their resources. We do not assume any responsibility or
                    liability for the actions, products, services, and content
                    of any other third parties. You should carefully review the
                    legal statements and other conditions of use of any resource
                    which you access through a link on the Services. Your
            ...
            <div className="flex flex-col space-y-4 mt-5">
                ...
                <p>
                    ...
                    not transfer to you any intellectual property owned by
                    Nesterin LLC or third parties, and all rights, titles, and
                    interests in and to such property will remain (as between
                    the parties) solely with Nesterin LLC. All trademarks,
                    service marks, graphics and logos used in connection with
                    the Services, are trademarks or registered trademarks of
                    Nesterin LLC or its licensors. Other trademarks, service
                    marks, graphics and logos used in connection with the
                    Services may be the trademarks of other third parties. Your
                    use of the Services grants you no right or license to
                    reproduce or otherwise use any of Nesterin LLC or third
                    party trademarks.
                </p>
            </div>
            <div className="flex flex-col space-y-4 mt-5">
                ...
                <p>
                    ...
                    event will Nesterin LLC, its affiliates, directors,
                    ...
                    liability of Nesterin LLC and its affiliates, officers,
                    ...
                    Nesterin LLC for the prior one month period prior to the
            ...
            <div className="flex flex-col space-y-4 mt-5">
                ...
                <p>
                    ...
                    governed by the substantive and procedural laws of Florida,
                    ...
                    courts located in Florida, United States, and you hereby
            ...
            <div className="flex flex-col space-y-4 mt-5">
                ...
                <p>
                    ...
                    page, post a notification within the Services, send you an
                    email to notify you. We may also provide notice to you in
