        ...
        <>
            <div className="parent-container border-b-[1px] border-tertiary-100">
                <div className="flex flex-col items-center justify-center">
                    ...
                    <p className="w-full lg:w-1/3 px-10 lg:px-0 text-center text-xl lg:text-[20px] font-light lg:font-extralight leading-[40px]">
            ...
            <div className="parent-container border-b-[1px] border-tertiary-100">
                <div className="w-full lg:max-w-[1200px] px-8 lg:px-0 flex flex-col justify-center items-center">
            ...
            <div className="parent-container">
                <div className="bg-neutral-200 p-8 rounded-lg flex flex-col justify-center items-center space-y-5 lg:max-w-[800px]">
                    <p className="font-oswald text-4xl text-tertiary-500 pb-6 lg:pb-10">
                        Our Team
                    </p>
                    <div className="flex flex-col gap-5 justify-center items-center lg:flex-row ">
                        <img
                            src="shuvo.jpg"
                            className="w-[250px] lg:w-[35%] max-w-[300px] h-auto border-4 border-tertiary-700 rounded-md"
                        />
                        <img
                            src="meow.jpg"
                            className="w-[250px] lg:w-[35%] max-w-[300px] h-auto border-4 border-tertiary-700 rounded-md"
